<?php
/**
 * loremipsum functions and definitions
 *
...
if (!function_exists('loremipsum_setup')) :
    ...
    function loremipsum_setup()
    {
         ...
         * If you're building a theme based on loremipsum, use a find and replace
        ...
        register_nav_menus(array(
            ...
            'footer-menu' => esc_html__('Footer menu', 'loremipsum')
        ));
        ...
        add_theme_support('custom-background', apply_filters('loremipsum_custom_background_args', array(
...
{
    wp_enqueue_style('loremipsum-style', get_stylesheet_uri());

    wp_enqueue_script('loremipsum-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true);

    wp_enqueue_script('loremipsum-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true);
...
require get_template_directory() . '/inc/customizer/extended-info.php';
